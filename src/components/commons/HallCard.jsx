    ...
    >
      <div className="hall-image-container">
        ...
        <div className="hall-overlay">
          <Link to={`/halls/${hall._id}`} className="view-details-btn">
            View Details
          </Link>
        </div>

        <button
          className={`favorite-btn ${user?.favorites?.includes(hall._id) ? "active" : ""}`}
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
            if (!isAuthenticated) {
        ...
        {showShare && (
          <div className="share-btn-container">
            ...
            {showShareMenu && (
              <div className="share-radial-menu" onClick={(e) => e.stopPropagation()}>
                <button
                  className="share-radial-option facebook"
                ...
                <button
                  className="share-radial-option whatsapp"
                ...
                <button
                  className="share-radial-option copy"
      ...
      <div className="hall-info">
        ...
        <div className="hall-details">
          <div className="detail-item">
            <span className="guest-label">Capacity:</span>
            <span>{hall.capacity} people</span>
          </div>
          <div className="detail-item">
            <span className="guest-label">Price:</span>
            <span>₹{hall.pricePerHour}/hr</span>
          </div>
        </div>
        <Link to={`/halls/${hall._id}`} className="btn-primary">
          View Detail
        </Link>
      </div>
    </motion.div>
