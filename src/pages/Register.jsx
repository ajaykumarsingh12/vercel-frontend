...
const Register = () => {
  ...
  const validatePhoneNumber = (phone) => {
    if (!phone.trim()) {
      return null; // Phone is optional for regular users
    }
  ...
  const handleBlur = (e) => {
    ...
    switch (name) {
      ...
      case 'phone':
        ...
        } else if (formData.role === "hall_owner") {
          error = "Phone number is required for hall owners";
        }
        break;
      default:
        break;
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.phone.trim()) {
      ...
      newErrors.phone = "Phone number is required for hall owners";
    }

    // Validate role
    if (!formData.role || !['user', 'hall_owner', 'admin'].includes(formData.role)) {
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-group">
            <label htmlFor="phone">
              ...
              Phone Number {formData.role === "hall_owner" && <span style={{ color: '#ef4444' }}>*</span>}
            </label>
            <div className="phone-input-wrapper">
              ...
              <input
                ...
                autoComplete="tel"
                required={formData.role === "hall_owner"}
                maxLength={11}
